    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-6 theme-transition">
      ...
      >
        <div className="flex items-center space-x-3.5 border-b border-slate-100 dark:border-slate-800 pb-6">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight">Post Verified Job Opening</h1>
            <p className="text-xs text-slate-500 dark:text-slate-400">Published openings automatically carry your organization's statutory TrustScore.</p>
          </div>
        </div>

        {errorMessage && (
          <div className="p-3.5 bg-rose-50 dark:bg-rose-500/10 border border-rose-500/30 text-rose-600 dark:text-rose-400 text-xs rounded-2xl">
            {errorMessage}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Job Type</label>
              <select
                name="jobType"
            ...
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Workplace Arrangement</label>
              <select
                name="workplaceType"
            ...
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Experience Designation</label>
              <select
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Max Compensation (INR / Year)</label>
              <input
                type="number"
                name="salaryMax"
          ...
          <div>
            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Full Job Description *</label>
            <textarea
              name="description"
              rows={4}
              required
          ...
          <div>
            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Key Responsibilities (One per line)</label>
            <textarea
          ...
          <div>
            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">Requirements & Qualifications (One per line)</label>
            <textarea
              name="requirements"
              rows={3}
          ...
          <div className="pt-3 flex justify-end space-x-3 border-t border-slate-100 dark:border-slate-800">
            <Link
              to="/employer/dashboard"
              className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-2xl"
            >
              Cancel
            </Link>
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 dark:bg-emerald-400 dark:hover:bg-emerald-300 text-white dark:text-slate-900 font-bold rounded-2xl transition disabled:opacity-50 flex items-center space-x-2 shadow-sm"
            >
